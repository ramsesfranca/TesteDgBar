...
namespace MinhaAplicacao.Dominio.Interfaces.Services
{
        ...
        where TRepositorioBase : IRepositorioBase<TId, TEntidade>
    {
        ...
        Task<TEntidade> SelecionarPorId(TId id, params string[] navegacao);
        Task<List<TEntidade>> SelecionarTodos(params string[] navegacao);
        Task<List<TEntidade>> SelecionarPor(Expression<Func<TEntidade, bool>> predicado, params string[] navegacao);
